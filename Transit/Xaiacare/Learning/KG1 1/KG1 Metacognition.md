---
tags: [metacognition, KG1, lesson-plan, early-education, cognitive-development]
created: 2025-04-29
author: EarlyEd Specialist
related-courses: [Cognitive Foundations, Play-Based Learning]
---
...
```mermaid
graph TD
  A[Lesson Objectives] --> B[Self-Awareness Activities]
  A --> C[Strategy Development]
  A --> D[Reflection Practice]
  B --> E[Think-Aloud Exercises]
...
![[Thinking Brain Graphic](https://example.com/metacognition-kids.png)]
...
pie
  ...
  "Building Challenges" : 35
  "Puzzle Reflection" : 25
```
...
![[Puzzle Graphic](https://example.com/mystery-box-puzzle.jpg)]
- **Resources**:

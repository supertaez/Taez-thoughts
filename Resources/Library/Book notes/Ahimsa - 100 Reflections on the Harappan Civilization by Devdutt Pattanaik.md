...
created: 2025-06-11
modified: 2025-06-11
aliases: [Ahimsa Book Analysis, Harappan Civilization Reflections]
tags:
  book
  nonviolence
  ancient_history
...
```mermaid
graph LR
A[Ahimsa Core Themes] --> B[Peaceful Civilization]
A --> C[Mercantile-Monastic Model]
A --> D[Cultural Continuity]
B --> E[Absence of Weapons/War Art]
C --> F[Trade Over Raid Philosophy]
D --> G[Link to Jain/Buddhist Traditions]
```
...
```mermaid
journey
  title Harappan Legacy in Modern India
  section Material Culture
    Sindhur(sindur): 5: Present
    Beadwork: 4: Jewelry
    Cotton: 5: Textiles
  section Philosophical Concepts
    Ahimsa: 5: Gandhi/Jainism
    Karma: 4: Hindu/Buddhist
```
